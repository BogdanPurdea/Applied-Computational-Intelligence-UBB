...
def main():
    ...
    output_dir = os.path.join(script_dir, "output_ita_bert")
    training_output_dir = os.path.join(output_dir, "ita_bert_training_results")

    # Creates the output directory if it does not exist.
    os.makedirs(output_dir, exist_ok=True)

    # Initializes the model identifier using the Italian Base BERT model.
