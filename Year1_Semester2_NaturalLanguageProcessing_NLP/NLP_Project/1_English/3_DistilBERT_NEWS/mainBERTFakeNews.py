...
def parse_args():
    parser = argparse.ArgumentParser(description="Train BERT on Fake News dataset")
    parser.add_argument("--data_path", type=str, default=os.path.join(parent_dir, "data", "welfake", "WELFake_Dataset.csv"))
    parser.add_argument("--output_dir", type=str, default=os.path.join(parent_dir, "outputs", "BERT_FakeNews"))
